...
- [2017\_ 做到这一点，你也可以成为优秀的程序员](https://mp.weixin.qq.com/s/8Bl105G8ZsE_jy5mbrIy_g)
...
- [2020\_技术管理的世界观](https://zhuanlan.zhihu.com/p/166099294): 这篇文章中的讨论主要适用于“通过技术实现业务(或产品)，然后通过业务盈利”这种类型的组织中。对于直接出售技术盈利、或者将技术外包类型的组织，部分结论可能不适用，但仍可借鉴其中的思路。
